...
```bash
sudo apt install -y git && git clone https://github.com/claydermanximenes/deployc.git && sudo chmod -R 777 instalodordeploy && cd instalodordeploy&& sudo ./install_primaria
```
